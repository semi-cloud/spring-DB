...
class MemberServiceV3_1Test {
    ...
    /**
     * DataSourceTransactionManager: JDBC 트랜잭션 매니저
     * dataSource를 주입해주지 않으면 커넥션 자체를 생성하지 못하는 문제 발생
     */
    @BeforeEach
    void init() {
        DriverManagerDataSource dataSource = new DriverManagerDataSource(URL, USERNAME, PASSWORD);
        repository = new MemberRepositoryV3(dataSource);
        // 기술 변경시 의존관계 주입만 DataSourceTransactionManager -> JpaTransactionManager 변경하면 비즈니스 로직에 영향 X
